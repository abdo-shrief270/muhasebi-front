  ...
  <div>
      ...
      <div v-else-if="messages.length" class="space-y-3">
        <div
          ...
          class="bg-white rounded-xl border p-4 transition-all cursor-pointer hover:border-gray-200"
          :class="msg.is_read ? 'border-gray-100/80' : 'border-s-4 border-s-secondary-400 border-gray-100/80'"
