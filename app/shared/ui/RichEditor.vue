<template>
  <div class="rich-editor" :dir="dir">
    <!-- Toolbar -->
    <div v-if="editor" class="flex flex-wrap items-center gap-1 p-2 bg-gray-50 border border-gray-200 rounded-t-xl border-b-0">
      <!-- Text formatting -->
      <button
        ...
        :class="btn.isActive?.() ? 'bg-primary-100 text-primary-600' : 'text-gray-400 hover:bg-gray-200 hover:text-gray-600'"
        :title="btn.title"
      >
      ...
      <select
        ...
        class="h-8 px-2 text-xs bg-white border border-gray-200 rounded-lg text-gray-600 cursor-pointer"
      >
      ...
      <button
        ...
        class="w-8 h-8 flex items-center justify-center rounded-lg text-sm transition-colors"
        :class="editor.isActive('bulletList') ? 'bg-primary-100 text-primary-600' : 'text-gray-400 hover:bg-gray-200 hover:text-gray-600'"
        title="Bullet List"
      >
      ...
      <button
        ...
        class="w-8 h-8 flex items-center justify-center rounded-lg text-sm transition-colors"
        :class="editor.isActive('orderedList') ? 'bg-primary-100 text-primary-600' : 'text-gray-400 hover:bg-gray-200 hover:text-gray-600'"
        title="Ordered List"
      >
      ...
      <button
        ...
        class="w-8 h-8 flex items-center justify-center rounded-lg text-sm transition-colors"
        :class="editor.isActive({ textAlign: align }) ? 'bg-primary-100 text-primary-600' : 'text-gray-400 hover:bg-gray-200 hover:text-gray-600'"
      >
      ...
      <button
        @click="addLink"
        class="w-8 h-8 flex items-center justify-center rounded-lg text-sm transition-colors"
        :class="editor.isActive('link') ? 'bg-primary-100 text-primary-600' : 'text-gray-400 hover:bg-gray-200 hover:text-gray-600'"
        title="Link"
      >
      ...
      <button
        ...
        class="w-8 h-8 flex items-center justify-center rounded-lg text-gray-400 hover:bg-gray-200 hover:text-gray-600 text-sm transition-colors"
        title="Divider"
      >
      ...
      <button @click="editor.chain().focus().undo().run()" :disabled="!editor.can().undo()" class="w-8 h-8 flex items-center justify-center rounded-lg text-gray-400 hover:bg-gray-200 hover:text-gray-600 disabled:opacity-30 text-sm transition-colors">
      ...
      <button @click="editor.chain().focus().redo().run()" :disabled="!editor.can().redo()" class="w-8 h-8 flex items-center justify-center rounded-lg text-gray-400 hover:bg-gray-200 hover:text-gray-600 disabled:opacity-30 text-sm transition-colors">
    ...
    <EditorContent
      :editor="editor"
      class="prose prose-sm max-w-none border border-gray-200 rounded-b-xl px-4 py-3 min-h-[300px] focus-within:border-primary-300 focus-within:ring-1 focus-within:ring-primary-100 transition-colors"
